...
from src.core.artifacts.use_cases import AddArtifactToMissionUseCase
...
class TestAddArtifactToMissionUseCase(FactoryFixture):
    @pytest.fixture(autouse=True)
    async def setup(self) -> None:
        self.storage = StorageMock()
        self.use_case = AddArtifactToMissionUseCase(
